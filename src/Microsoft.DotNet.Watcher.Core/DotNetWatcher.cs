...
namespace Microsoft.DotNet.Watcher.Core
{
    public class DotNetWatcher
    {
        ...
        public async Task WatchAsync(string projectFile, string[] dotnetArguments, string workingDir, CancellationToken cancellationToken)
        {
            dotnetArguments = new string[] { "run", "--project", projectFile }
